...
public:
	...
	int popBack();								//возвращает поcледний элемент, size уменьшается на 1
	void insert(int index, int val);			//вставляет элемент val на позицию index, при необходимости выделяется новая память
